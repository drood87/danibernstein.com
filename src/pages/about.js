  ...
  render() {
    return (
      <Layout>
        ...
        <p>
          I relish traveling to different places in the world and meeting new interesting people along the way. I enjoy
          exploring new cultures, countries and ways of living.
          {' '}
